 ...
 * @author Tian
 */
public class Jamur_Mucor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pemyakit Jamur Mucor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jamur_Mucor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Jamur_Mucor().setVisible(true);
            }
        });
    }
