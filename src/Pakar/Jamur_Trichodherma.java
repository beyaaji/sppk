 ...
 * @author Tian
 */
public class Jamur_Trichodherma extends javax.swing.JFrame {

    /**
     * Creates new form Abases_Parafaringeal
     */
    public Jamur_Trichodherma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("Trichoderma biasanya banyak terdapat pada media log jamur yang telah mati atau pada permukaan tanah.");
        jScrollPane2.setViewportView(jTextArea2);

        jTextArea3.setColumns(20);
        jTextArea3.setLineWrap(true);
        jTextArea3.setRows(5);
        jTextArea3.setText("Cara mengatasi masalah ini adalah dengan segera membuang media log jamur tiram yang telah terkontaminasi.");
        ...
        jTextArea4.setText("pencegahannya dapat dilakukan dengan melakukan sterilisasi/desinfektasi tenaga kerja dan peralatan yang digunakan untuk perawatan kumbung.");
        jScrollPane4.setViewportView(jTextArea4);

        jTextArea1.setColumns(20);
        jTextArea1.setLineWrap(true);
        jTextArea1.setRows(5);
        jTextArea1.setText("Trichoderma dapat menyebar melalui udara atau terbawa oleh pekerja. Ciri-ciri kontaminasi yang disebabkan oleh jamur ini adalah timbulnya bintik bintik atau noda hijau pada media baglog jamur tiram sehingga pertumbuhan miselium jamur tiram menjadi terhambat.");
        ...
        jLabel3.setText("Penyakit Jamur Tricodherma");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jamur_Trichodherma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
